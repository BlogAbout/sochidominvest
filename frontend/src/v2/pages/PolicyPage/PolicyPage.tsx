...
const PolicyPage: React.FC = (): React.ReactElement => {
    return (
        <DefaultView pageTitle='Политика конфиденциальности'>
            <Wrapper>
                <Title type='h1' style='center'>Политика конфиденциальности</Title>

                <Title type='h3'>1. Общие положения</Title>
                ...
                <p>
                    ...
                    обеспечению безопасности персональных данных, предпринимаемые Индивидуальным
                    Предпринимателем Прохоровой Тамарой Павловной (далее – Оператор).
                </p>
                <ol className={classes.withOutStyle}>
                    <li>
                ...
                <Title type='h3'>2. Основные понятия, используемые в Политике</Title>
                ...
                <Title type='h3'>3. Основные права и обязанности Оператора</Title>
                ...
                <Title type='h3'>4. Основные права и обязанности субъектов персональных данных</Title>
                ...
                <Title type='h3'>5. Оператор может обрабатывать следующие персональные данные Пользователя</Title>
                ...
                <Title type='h3'>6. Принципы обработки персональных данных</Title>
                ...
                <Title type='h3'>7. Цели обработки персональных данных</Title>
                ...
                <ol className={classes.withOutStyle}>
                    ...
                    <li>
                        ...
                        info@sochidominvest.ru с пометкой «Отказ от уведомлений о новых продуктах и услугах и
                ...
                <Title type='h3'>8. Правовые основания обработки персональных данных</Title>
                ...
                <Title type='h3'>9. Условия обработки персональных данных</Title>
                ...
                <Title type='h3'>10. Порядок сбора, хранения, передачи и других видов обработки персональных
                    данных</Title>
                ...
                <ol className={classes.withOutStyle}>
                    ...
                    <li>
                        ...
                        либо в
                        случае,
                        если субъектом персональных данных дано согласие Оператору на передачу данных третьему
                        лицу
                        для
                    ...
                    <li>
                        ...
                        Оператора
                        info@sochidominvest.ru с пометкой «Актуализация персональных данных».
                    </li>
                    <li>
                        ...
                        законодательством.Пользователь
                        ...
                        info@sochidominvest.ru с пометкой «Отзыв согласия на обработку персональных данных».
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        обработки
                        персональных данных, истечение срока действия согласия субъекта персональных данных или
                        отзыв
                ...
                <Title type='h3'>11. Перечень действий, производимых Оператором с полученными персональными
                    данными</Title>
                ...
                <Title type='h3'>12. Трансграничная передача персональных данных</Title>
                ...
                <Title type='h3'>13. Конфиденциальность персональных данных</Title>
                ...
                <Title type='h3'>14. Заключительные положения</Title>
